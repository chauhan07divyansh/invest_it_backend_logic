...
from database.position_trading_system_db import StockDBMixin
    ...
    def __init__(self, data_provider=None, mda_processor=None, redis_client=None):
        try:
            ...
            if not data_provider:
                raise ValueError("❌ data_provider is REQUIRED for PositionTradingSystem")

            self.data_provider = data_provider
            logger.info("✅ Data provider injected into PositionTradingSystem")

            # ✅ --- INITIALIZE DATABASE AFTER DEPENDENCIES ---
            self._init_stock_db()
            ...
            if redis_client:
                ...
                logger.warning("⚠️ No Redis cache - performance may be slower")
            ...
            logger.error(f"❌ Error initializing EnhancedPositionTradingSystem: {e}", exc_info=True)
            raise
    # ==============================================================================
