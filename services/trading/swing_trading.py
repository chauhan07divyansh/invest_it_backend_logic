...
SMALLCAP_STOCKS = {
                "ACMESOLAR": {"name": "ACME Solar Holdings", "sector": "Power"},
                "AADHARHFC": {"name": "Aadhar Housing Finance", "sector": "Financial Services"},
                "AARTIIND": {"name": "Aarti Industries", "sector": "Chemicals"},
                "ACE": {"name": "Action Construction Equipment", "sector": "Capital Goods"},
                "ACUTAAS": {"name": "Acutaas Chemicals", "sector": "Healthcare"},
                "ABLBL": {"name": "Aditya Birla Lifestyle Brands", "sector": "Consumer Services"},
                "ABREL": {"name": "Aditya Birla Real Estate", "sector": "Realty"},
                "ABSLAMC": {"name": "Aditya Birla Sun Life AMC", "sector": "Financial Services"},
                "CPPLUS": {"name": "Aditya Infotech", "sector": "Capital Goods"},
                "AEGISLOG": {"name": "Aegis Logistics", "sector": "Oil Gas & Consumable Fuels"},
                "AEGISVOPAK": {"name": "Aegis Vopak Terminals", "sector": "Oil Gas & Consumable Fuels"},
                "AFCONS": {"name": "Afcons Infrastructure", "sector": "Construction"},
                "ABDL": {"name": "Allied Blenders and Distillers", "sector": "Fast Moving Consumer Goods"},
                "ARE&M": {"name": "Amara Raja", "sector": "Automobile and Auto Components"},
                "ANANTRAJ": {"name": "Anant Raj", "sector": "Realty"},
                "ANURAS": {"name": "Anupam Rasayan", "sector": "Chemicals"},
                "APTUS": {"name": "Aptus Value Housing Finance", "sector": "Financial Services"},
                "ASAHIINDIA": {"name": "Asahi India Glass", "sector": "Automobile and Auto Components"},
                "ASTERDM": {"name": "Aster DM Healthcare", "sector": "Healthcare"},
                "ATHERENERG": {"name": "Ather Energy", "sector": "Automobile and Auto Components"},
                "BEML": {"name": "BEML", "sector": "Capital Goods"},
                "BLS": {"name": "BLS International Services", "sector": "Consumer Services"},
                "BALRAMCHIN": {"name": "Balrampur Chini Mills", "sector": "Fast Moving Consumer Goods"},
                "BAYERCROP": {"name": "Bayer Cropscience", "sector": "Chemicals"},
                "BELRISE": {"name": "Belrise Industries", "sector": "Automobile and Auto Components"},
                "BIKAJI": {"name": "Bikaji Foods International", "sector": "Fast Moving Consumer Goods"},
                "BSOFT": {"name": "Birlasoft", "sector": "Information Technology"},
                "BLUEDART": {"name": "Blue Dart Express", "sector": "Services"},
                "BLUEJET": {"name": "Blue Jet Healthcare", "sector": "Healthcare"},
                "BBTC": {"name": "Bombay Burmah", "sector": "Fast Moving Consumer Goods"},
                "FIRSTCRY": {"name": "Brainbees Solutions", "sector": "Consumer Services"},
                "MAPMYINDIA": {"name": "MapmyIndia", "sector": "Information Technology"},
                "CCL": {"name": "CCL Products", "sector": "Fast Moving Consumer Goods"},
                "CIEINDIA": {"name": "CIE Automotive India", "sector": "Automobile and Auto Components"},
                "CANFINHOME": {"name": "Can Fin Homes", "sector": "Financial Services"},
                "CANHLIFE": {"name": "Canara HSBC Life Insurance", "sector": "Financial Services"},
                "CAPLIPOINT": {"name": "Caplin Point Laboratories", "sector": "Healthcare"},
                "CGCL": {"name": "Capri Global Capital", "sector": "Financial Services"},
                "CARBORUNIV": {"name": "Carborundum Universal", "sector": "Capital Goods"},
                "CARTRADE": {"name": "Cartrade Tech", "sector": "Consumer Services"},
                "CASTROLIND": {"name": "Castrol India", "sector": "Oil Gas & Consumable Fuels"},
                "CEATLTD": {"name": "Ceat", "sector": "Automobile and Auto Components"},
                "CEMPRO": {"name": "Cemindia Projects", "sector": "Construction"},
                "CHALET": {"name": "Chalet Hotels", "sector": "Consumer Services"},
                "CHENNPETRO": {"name": "Chennai Petroleum", "sector": "Oil Gas & Consumable Fuels"},
                "CHOICEIN": {"name": "Choice International", "sector": "Financial Services"},
                "CHOLAHLDNG": {"name": "Cholamandalam Financial Holdings", "sector": "Financial Services"},
                "COHANCE": {"name": "Cohance Lifesciences", "sector": "Healthcare"},
                "CONCORDBIO": {"name": "Concord Biotech", "sector": "Healthcare"},
                "CRAFTSMAN": {"name": "Craftsman Automation", "sector": "Automobile and Auto Components"},
                "DCMSHRIRAM": {"name": "DCM Shriram", "sector": "Diversified"},
                "DOMS": {"name": "DOMS Industries", "sector": "Fast Moving Consumer Goods"},
                "DATAPATTNS": {"name": "Data Patterns (India)", "sector": "Capital Goods"},
                "DEEPAKFERT": {"name": "Deepak Fertilisers", "sector": "Chemicals"},
                "DELHIVERY": {"name": "Delhivery", "sector": "Services"},
                "EIDPARRY": {"name": "E.I.D. Parry (India)", "sector": "Fast Moving Consumer Goods"},
                "EIHOTEL": {"name": "EIH Hotels", "sector": "Consumer Services"},
                "ELECON": {"name": "Elecon Engineering", "sector": "Capital Goods"},
                "ELGIEQUIP": {"name": "Elgi Equipments", "sector": "Capital Goods"},
                "EMCURE": {"name": "Emcure Pharmaceuticals", "sector": "Healthcare"},
                "EMMVEE": {"name": "Emmvee Photovoltaic", "sector": "Capital Goods"},
                "ENGINERSIN": {"name": "Engineers India", "sector": "Construction"},
                "ERIS": {"name": "Eris Lifesciences", "sector": "Healthcare"},
                "FINCABLES": {"name": "Finolex Cables", "sector": "Capital Goods"},
                "FSL": {"name": "Firstsource Solutions", "sector": "Services"},
                "FIVESTAR": {"name": "Five-Star Business Finance", "sector": "Financial Services"},
                "FORCEMOT": {"name": "Force Motors", "sector": "Automobile and Auto Components"},
                "GABRIEL": {"name": "Gabriel India", "sector": "Automobile and Auto Components"},
                "GALLANTT": {"name": "Gallantt Ispat", "sector": "Capital Goods"},
                "GRSE": {"name": "Garden Reach Shipbuilders", "sector": "Capital Goods"},
                "GILLETTE": {"name": "Gillette India", "sector": "Fast Moving Consumer Goods"},
                "GLAND": {"name": "Gland Pharma", "sector": "Healthcare"},
                "GODIGIT": {"name": "Go Digit", "sector": "Financial Services"},
                "GPIL": {"name": "Godawari Power & Ispat", "sector": "Capital Goods"},
                "GRAVITA": {"name": "Gravita India", "sector": "Metals & Mining"},
                "GESHIP": {"name": "Great Eastern Shipping", "sector": "Services"},
                "GMDCLTD": {"name": "Gujarat Mineral Development", "sector": "Metals & Mining"},
                "HEG": {"name": "H.E.G", "sector": "Capital Goods"},
                "HBLENGINE": {"name": "HBL Engineering", "sector": "Capital Goods"},
                "HSCL": {"name": "Himadri Speciality Chemical", "sector": "Chemicals"},
                "HOMEFIRST": {"name": "Home First Finance Company India", "sector": "Financial Services"},
                "HONASA": {"name": "Honasa Consumer", "sector": "Fast Moving Consumer Goods"},
                "IDBI": {"name": "IDBI Bank", "sector": "Financial Services"},
                "IFCI": {"name": "IFCI", "sector": "Financial Services"},
                "IIFL": {"name": "IIFL Finance", "sector": "Financial Services"},
                "IRB": {"name": "IRB Infrastructure Developers", "sector": "Construction"},
                "IRCON": {"name": "IRCON International", "sector": "Construction"},
                "ITI": {"name": "ITI", "sector": "Telecommunication"},
                "INDGN": {"name": "Indegene", "sector": "Healthcare"},
                "INDIACEM": {"name": "India Cements", "sector": "Construction Materials"},
                "IOB": {"name": "Indian Overseas Bank", "sector": "Financial Services"},
                "INOXWIND": {"name": "Inox Wind", "sector": "Capital Goods"},
                "IGIL": {"name": "International Gemological Institute", "sector": "Services"},
                "IKS": {"name": "Inventurus Knowledge Solutions", "sector": "Information Technology"},
                "JBCHEPHARM": {"name": "J.B. Chemicals & Pharmaceuticals", "sector": "Healthcare"},
                "JBMA": {"name": "JBM Auto", "sector": "Automobile and Auto Components"},
                "JKTYRE": {"name": "JK Tyre & Industries", "sector": "Automobile and Auto Components"},
                "JMFINANCIL": {"name": "JM Financial", "sector": "Financial Services"},
                "JSWCEMENT": {"name": "JSW Cement", "sector": "Construction Materials"},
                "JSWDULUX": {"name": "JSW Dulux", "sector": "Consumer Durables"},
                "JAINREC": {"name": "Jain Resource Recycling", "sector": "Metals & Mining"},
                "JPPOWER": {"name": "Jaiprakash Power Ventures", "sector": "Power"},
                "J&KBANK": {"name": "Jammu & Kashmir Bank", "sector": "Financial Services"},
                "JINDALSAW": {"name": "Jindal Saw", "sector": "Capital Goods"},
                "JUBLINGREA": {"name": "Jubilant Ingrevia", "sector": "Chemicals"},
                "JWL": {"name": "Jupiter Wagons", "sector": "Capital Goods"},
                "JYOTICNC": {"name": "Jyoti CNC Automation", "sector": "Capital Goods"},
                "KPIL": {"name": "Kalpataru Projects International", "sector": "Construction"},
                "KARURVYSYA": {"name": "Karur Vysya Bank", "sector": "Financial Services"},
                "KAYNES": {"name": "Kaynes Technology", "sector": "Capital Goods"},
                "KEC": {"name": "Kec International", "sector": "Construction"},
                "KFINTECH": {"name": "Kfin Technologies", "sector": "Financial Services"},
                "KIRLOSENG": {"name": "Kirloskar Oil Eng", "sector": "Capital Goods"},
                "KIMS": {"name": "Krishna Institute of Medical Sciences", "sector": "Healthcare"},
                "LTFOODS": {"name": "LT Foods", "sector": "Fast Moving Consumer Goods"},
                "THELEELA": {"name": "Leela Hotels", "sector": "Consumer Services"},
                "MMTC": {"name": "MMTC", "sector": "Services"},
                "MRPL": {"name": "Mangalore Refinery & Petrochemicals", "sector": "Oil Gas & Consumable Fuels"},
                "MEESHO": {"name": "Meesho", "sector": "Consumer Services"},
                "MINDACORP": {"name": "Minda", "sector": "Automobile and Auto Components"},
                "MSUMI": {"name": "Motherson Sumi Wiring India", "sector": "Automobile and Auto Components"},
                "NATCOPHARM": {"name": "NATCO Pharma", "sector": "Healthcare"},
                "NBCC": {"name": "NBCC", "sector": "Construction"},
                "NCC": {"name": "NCC", "sector": "Construction"},
                "NSLNISP": {"name": "NMDC Steel", "sector": "Metals & Mining"},
                "NH": {"name": "Narayana Hrudayalaya", "sector": "Healthcare"},
                "NAVA": {"name": "Nava", "sector": "Power"},
                "NETWEB": {"name": "Netweb Technologies India", "sector": "Information Technology"},
                "NEULANDLAB": {"name": "Neuland Laboratories", "sector": "Healthcare"},
                "NEWGEN": {"name": "Newgen Software Technologies", "sector": "Information Technology"},
                "NIVABUPA": {"name": "Niva Bupa", "sector": "Financial Services"},
                "NUVAMA": {"name": "Nuvama Wealth Management", "sector": "Financial Services"},
                "NUVOCO": {"name": "Nuvoco Vistas", "sector": "Construction Materials"},
                "OLAELEC": {"name": "Ola Electric Mobility", "sector": "Automobile and Auto Components"},
                "OLECTRA": {"name": "Olectra Greentech", "sector": "Automobile and Auto Components"},
                "ONESOURCE": {"name": "Onesource Specialty Pharma", "sector": "Healthcare"},
                "PCBL": {"name": "PCBL Chemical", "sector": "Chemicals"},
                "PGEL": {"name": "PG Electroplast", "sector": "Consumer Durables"},
                "PTCIL": {"name": "PTC Industries", "sector": "Capital Goods"},
                "PVRINOX": {"name": "PVR INOX", "sector": "Media Entertainment & Publication"},
                "PARADEEP": {"name": "Paradeep Phosphates", "sector": "Chemicals"},
                "PFIZER": {"name": "Pfizer", "sector": "Healthcare"},
                "PWL": {"name": "Physicswallah", "sector": "Consumer Services"},
                "PINELABS": {"name": "Pine Labs", "sector": "Financial Services"},
                "PIRAMALFIN": {"name": "Piramal Finance", "sector": "Financial Services"},
                "PPLPHARMA": {"name": "Piramal Pharma", "sector": "Healthcare"},
                "POLYMED": {"name": "Poly Medicure", "sector": "Healthcare"},
                "RRKABEL": {"name": "R R Kabel", "sector": "Capital Goods"},
                "RBLBANK": {"name": "RBL Bank", "sector": "Financial Services"},
                "RHIM": {"name": "RHI Magnesita India", "sector": "Capital Goods"},
                "RITES": {"name": "RITES", "sector": "Construction"},
                "RAINBOW": {"name": "Rainbow Childrens Medicare", "sector": "Healthcare"},
                "RKFORGE": {"name": "Ramkrishna Forgings", "sector": "Automobile and Auto Components"},
                "REDINGTON": {"name": "Redington", "sector": "Services"},
                "RPOWER": {"name": "Reliance Power", "sector": "Power"},
                "SBFC": {"name": "SBFC Finance", "sector": "Financial Services"},
                "SAGILITY": {"name": "Sagility", "sector": "Information Technology"},
                "SAILIFE": {"name": "Sai Life Sciences", "sector": "Healthcare"},
                "SAMMAANCAP": {"name": "Sammaan Capital", "sector": "Financial Services"},
                "SAPPHIRE": {"name": "Sapphire Foods India", "sector": "Consumer Services"},
                "SARDAEN": {"name": "Sarda Energy", "sector": "Metals & Mining"},
                "SAREGAMA": {"name": "Saregama India", "sector": "Media Entertainment & Publication"},
                "SCHNEIDER": {"name": "Schneider Electric Infrastructure", "sector": "Capital Goods"},
                "SCI": {"name": "Shipping Corporation of India", "sector": "Services"},
                "SOBHA": {"name": "Sobha", "sector": "Realty"},
                "SONATSOFTW": {"name": "Sonata Software", "sector": "Information Technology"},
                "STARHEALTH": {"name": "Star Health and Allied Insurance", "sector": "Financial Services"},
                "SUMICHEM": {"name": "Sumitomo Chemical India", "sector": "Chemicals"},
                "SUNTV": {"name": "Sun TV Network", "sector": "Media Entertainment & Publication"},
                "SPLPETRO": {"name": "Supreme Petrochem", "sector": "Chemicals"},
                "SWANCORP": {"name": "Swan", "sector": "Chemicals"},
                "SYRMA": {"name": "Syrma SGS Technology", "sector": "Capital Goods"},
                "TBOTEK": {"name": "TBO Tek", "sector": "Consumer Services"},
                "TATACHEM": {"name": "Tata Chemicals", "sector": "Chemicals"},
                "TATATECH": {"name": "Tata Technologies", "sector": "Information Technology"},
                "TTML": {"name": "Tata Teleservices (Maharashtra)", "sector": "Telecommunication"},
                "TECHNOE": {"name": "Techno Electric & Engineering", "sector": "Construction"},
                "TEGA": {"name": "Tega Industries", "sector": "Capital Goods"},
                "TEJASNET": {"name": "Tejas Networks", "sector": "Telecommunication"},
                "TENNIND": {"name": "Tenneco Clean Air", "sector": "Automobile and Auto Components"},
                "RAMCOCEM": {"name": "The Ramco Cements", "sector": "Construction Materials"},
                "TIMKEN": {"name": "Timken India", "sector": "Capital Goods"},
                "TITAGARH": {"name": "Titagarh Rail Systems", "sector": "Capital Goods"},
                "TARIL": {"name": "Transformers And Rectifiers (India)", "sector": "Capital Goods"},
                "TRAVELFOOD": {"name": "Travel Food Services", "sector": "Consumer Services"},
                "TRIDENT": {"name": "Trident", "sector": "Textiles"},
                "TRITURBINE": {"name": "Triveni Turbine", "sector": "Capital Goods"},
                "URBANCO": {"name": "Urban", "sector": "Consumer Services"},
                "USHAMART": {"name": "Usha Martin", "sector": "Capital Goods"},
                "VTL": {"name": "Vardhman Textiles", "sector": "Textiles"},
                "VIJAYA": {"name": "Vijaya Diagnostic Centre", "sector": "Healthcare"},
                "WELCORP": {"name": "Welspun", "sector": "Capital Goods"},
                "WELSPUNLIV": {"name": "Welspun Living", "sector": "Textiles"},
                "WOCKPHARMA": {"name": "Wockhardt", "sector": "Healthcare"},
                "ZFCVINDIA": {"name": "ZF Commercial Vehicle Control Systems", "sector": "Automobile and Auto Components"},
                "ZEEL": {"name": "Zee Entertainment Enterprises", "sector": "Media Entertainment & Publication"},
                "ZENTEC": {"name": "Zen Technologies", "sector": "Capital Goods"},
                "ZENSARTECH": {"name": "Zensar Technologies", "sector": "Information Technology"},
                "ZYDUSWELL": {"name": "Zydus Wellness", "sector": "Fast Moving Consumer Goods"},
                "ECLERX": {"name": "eClerx Services", "sector": "Services"},
}
