...
ENABLE_SMALLCAPS = os.getenv('ENABLE_SMALLCAPS', 'false').lower() == 'true'
# 200 new stock entries
SMALLCAP_STOCKS = {
                "ACMESOLAR": {"name": "ACME Solar Holdings Ltd.", "sector": "Power"},
                "AADHARHFC": {"name": "Aadhar Housing Finance Ltd.", "sector": "Financial Services"},
                "AARTIIND": {"name": "Aarti Industries Ltd.", "sector": "Chemicals"},
                "ACE": {"name": "Action Construction Equipment Ltd.", "sector": "Capital Goods"},
                "ACUTAAS": {"name": "Acutaas Chemicals Ltd.", "sector": "Healthcare"},
                "ABLBL": {"name": "Aditya Birla Lifestyle Brands Ltd.", "sector": "Consumer Services"},
                "ABREL": {"name": "Aditya Birla Real Estate Ltd.", "sector": "Realty"},
                "ABSLAMC": {"name": "Aditya Birla Sun Life AMC Ltd.", "sector": "Financial Services"},
                "CPPLUS": {"name": "Aditya Infotech Ltd.", "sector": "Capital Goods"},
                "AEGISLOG": {"name": "Aegis Logistics Ltd.", "sector": "Oil Gas & Consumable Fuels"},
                "AEGISVOPAK": {"name": "Aegis Vopak Terminals Ltd.", "sector": "Oil Gas & Consumable Fuels"},
                "AFCONS": {"name": "Afcons Infrastructure Ltd.", "sector": "Construction"},
                "ABDL": {"name": "Allied Blenders and Distillers Ltd.", "sector": "Fast Moving Consumer Goods"},
                "ARE&M": {"name": "Amara Raja Energy & Mobility Ltd.", "sector": "Automobile and Auto Components"},
                "ANANTRAJ": {"name": "Anant Raj Ltd.", "sector": "Realty"},
                "ANURAS": {"name": "Anupam Rasayan India Ltd.", "sector": "Chemicals"},
                "APTUS": {"name": "Aptus Value Housing Finance India Ltd.", "sector": "Financial Services"},
                "ASAHIINDIA": {"name": "Asahi India Glass Ltd.", "sector": "Automobile and Auto Components"},
                "ASTERDM": {"name": "Aster DM Healthcare Ltd.", "sector": "Healthcare"},
                "ATHERENERG": {"name": "Ather Energy Ltd.", "sector": "Automobile and Auto Components"},
                "BEML": {"name": "BEML Ltd.", "sector": "Capital Goods"},
                "BLS": {"name": "BLS International Services Ltd.", "sector": "Consumer Services"},
                "BALRAMCHIN": {"name": "Balrampur Chini Mills Ltd.", "sector": "Fast Moving Consumer Goods"},
                "BAYERCROP": {"name": "Bayer Cropscience Ltd.", "sector": "Chemicals"},
                "BELRISE": {"name": "Belrise Industries Ltd.", "sector": "Automobile and Auto Components"},
                "BIKAJI": {"name": "Bikaji Foods International Ltd.", "sector": "Fast Moving Consumer Goods"},
                "BSOFT": {"name": "Birlasoft Ltd.", "sector": "Information Technology"},
                "BLUEDART": {"name": "Blue Dart Express Ltd.", "sector": "Services"},
                "BLUEJET": {"name": "Blue Jet Healthcare Ltd.", "sector": "Healthcare"},
                "BBTC": {"name": "Bombay Burmah Trading Corporation Ltd.", "sector": "Fast Moving Consumer Goods"},
                "FIRSTCRY": {"name": "Brainbees Solutions Ltd.", "sector": "Consumer Services"},
                "MAPMYINDIA": {"name": "C.E. Info Systems Ltd.", "sector": "Information Technology"},
                "CCL": {"name": "CCL Products (I) Ltd.", "sector": "Fast Moving Consumer Goods"},
                "CIEINDIA": {"name": "CIE Automotive India Ltd.", "sector": "Automobile and Auto Components"},
                "CANFINHOME": {"name": "Can Fin Homes Ltd.", "sector": "Financial Services"},
                "CANHLIFE": {"name": "Canara HSBC Life Insurance Company Ltd.", "sector": "Financial Services"},
                "CAPLIPOINT": {"name": "Caplin Point Laboratories Ltd.", "sector": "Healthcare"},
                "CGCL": {"name": "Capri Global Capital Ltd.", "sector": "Financial Services"},
                "CARBORUNIV": {"name": "Carborundum Universal Ltd.", "sector": "Capital Goods"},
                "CARTRADE": {"name": "Cartrade Tech Ltd.", "sector": "Consumer Services"},
                "CASTROLIND": {"name": "Castrol India Ltd.", "sector": "Oil Gas & Consumable Fuels"},
                "CEATLTD": {"name": "Ceat Ltd.", "sector": "Automobile and Auto Components"},
                "CEMPRO": {"name": "Cemindia Projects Ltd.", "sector": "Construction"},
                "CHALET": {"name": "Chalet Hotels Ltd.", "sector": "Consumer Services"},
                "CHENNPETRO": {"name": "Chennai Petroleum Corporation Ltd.", "sector": "Oil Gas & Consumable Fuels"},
                "CHOICEIN": {"name": "Choice International Ltd.", "sector": "Financial Services"},
                "CHOLAHLDNG": {"name": "Cholamandalam Financial Holdings Ltd.", "sector": "Financial Services"},
                "COHANCE": {"name": "Cohance Lifesciences Ltd.", "sector": "Healthcare"},
                "CONCORDBIO": {"name": "Concord Biotech Ltd.", "sector": "Healthcare"},
                "CRAFTSMAN": {"name": "Craftsman Automation Ltd.", "sector": "Automobile and Auto Components"},
                "DCMSHRIRAM": {"name": "DCM Shriram Ltd.", "sector": "Diversified"},
                "DOMS": {"name": "DOMS Industries Ltd.", "sector": "Fast Moving Consumer Goods"},
                "DATAPATTNS": {"name": "Data Patterns (India) Ltd.", "sector": "Capital Goods"},
                "DEEPAKFERT": {"name": "Deepak Fertilisers & Petrochemicals Corp. Ltd.", "sector": "Chemicals"},
                "DELHIVERY": {"name": "Delhivery Ltd.", "sector": "Services"},
                "EIDPARRY": {"name": "E.I.D. Parry (India) Ltd.", "sector": "Fast Moving Consumer Goods"},
                "EIHOTEL": {"name": "EIH Ltd.", "sector": "Consumer Services"},
                "ELECON": {"name": "Elecon Engineering Co. Ltd.", "sector": "Capital Goods"},
                "ELGIEQUIP": {"name": "Elgi Equipments Ltd.", "sector": "Capital Goods"},
                "EMCURE": {"name": "Emcure Pharmaceuticals Ltd.", "sector": "Healthcare"},
                "EMMVEE": {"name": "Emmvee Photovoltaic Power Ltd.", "sector": "Capital Goods"},
                "ENGINERSIN": {"name": "Engineers India Ltd.", "sector": "Construction"},
                "ERIS": {"name": "Eris Lifesciences Ltd.", "sector": "Healthcare"},
                "FINCABLES": {"name": "Finolex Cables Ltd.", "sector": "Capital Goods"},
                "FSL": {"name": "Firstsource Solutions Ltd.", "sector": "Services"},
                "FIVESTAR": {"name": "Five-Star Business Finance Ltd.", "sector": "Financial Services"},
                "FORCEMOT": {"name": "Force Motors Ltd.", "sector": "Automobile and Auto Components"},
                "GABRIEL": {"name": "Gabriel India Ltd.", "sector": "Automobile and Auto Components"},
                "GALLANTT": {"name": "Gallantt Ispat Ltd.", "sector": "Capital Goods"},
                "GRSE": {"name": "Garden Reach Shipbuilders & Engineers Ltd.", "sector": "Capital Goods"},
                "GILLETTE": {"name": "Gillette India Ltd.", "sector": "Fast Moving Consumer Goods"},
                "GLAND": {"name": "Gland Pharma Ltd.", "sector": "Healthcare"},
                "GODIGIT": {"name": "Go Digit General Insurance Ltd.", "sector": "Financial Services"},
                "GPIL": {"name": "Godawari Power & Ispat Ltd.", "sector": "Capital Goods"},
                "GRAVITA": {"name": "Gravita India Ltd.", "sector": "Metals & Mining"},
                "GESHIP": {"name": "Great Eastern Shipping Co. Ltd.", "sector": "Services"},
                "GMDCLTD": {"name": "Gujarat Mineral Development Corporation Ltd.", "sector": "Metals & Mining"},
                "HEG": {"name": "H.E.G. Ltd.", "sector": "Capital Goods"},
                "HBLENGINE": {"name": "HBL Engineering Ltd.", "sector": "Capital Goods"},
                "HSCL": {"name": "Himadri Speciality Chemical Ltd.", "sector": "Chemicals"},
                "HOMEFIRST": {"name": "Home First Finance Company India Ltd.", "sector": "Financial Services"},
                "HONASA": {"name": "Honasa Consumer Ltd.", "sector": "Fast Moving Consumer Goods"},
                "IDBI": {"name": "IDBI Bank Ltd.", "sector": "Financial Services"},
                "IFCI": {"name": "IFCI Ltd.", "sector": "Financial Services"},
                "IIFL": {"name": "IIFL Finance Ltd.", "sector": "Financial Services"},
                "IRB": {"name": "IRB Infrastructure Developers Ltd.", "sector": "Construction"},
                "IRCON": {"name": "IRCON International Ltd.", "sector": "Construction"},
                "ITI": {"name": "ITI Ltd.", "sector": "Telecommunication"},
                "INDGN": {"name": "Indegene Ltd.", "sector": "Healthcare"},
                "INDIACEM": {"name": "India Cements Ltd.", "sector": "Construction Materials"},
                "IOB": {"name": "Indian Overseas Bank", "sector": "Financial Services"},
                "INOXWIND": {"name": "Inox Wind Ltd.", "sector": "Capital Goods"},
                "IGIL": {"name": "International Gemological Institute Ltd.", "sector": "Services"},
                "IKS": {"name": "Inventurus Knowledge Solutions Ltd.", "sector": "Information Technology"},
                "JBCHEPHARM": {"name": "J.B. Chemicals & Pharmaceuticals Ltd.", "sector": "Healthcare"},
                "JBMA": {"name": "JBM Auto Ltd.", "sector": "Automobile and Auto Components"},
                "JKTYRE": {"name": "JK Tyre & Industries Ltd.", "sector": "Automobile and Auto Components"},
                "JMFINANCIL": {"name": "JM Financial Ltd.", "sector": "Financial Services"},
                "JSWCEMENT": {"name": "JSW Cement Ltd.", "sector": "Construction Materials"},
                "JSWDULUX": {"name": "JSW Dulux Ltd.", "sector": "Consumer Durables"},
                "JAINREC": {"name": "Jain Resource Recycling Ltd.", "sector": "Metals & Mining"},
                "JPPOWER": {"name": "Jaiprakash Power Ventures Ltd.", "sector": "Power"},
                "J&KBANK": {"name": "Jammu & Kashmir Bank Ltd.", "sector": "Financial Services"},
                "JINDALSAW": {"name": "Jindal Saw Ltd.", "sector": "Capital Goods"},
                "JUBLINGREA": {"name": "Jubilant Ingrevia Ltd.", "sector": "Chemicals"},
                "JWL": {"name": "Jupiter Wagons Ltd.", "sector": "Capital Goods"},
                "JYOTICNC": {"name": "Jyoti CNC Automation Ltd.", "sector": "Capital Goods"},
                "KPIL": {"name": "Kalpataru Projects International Ltd.", "sector": "Construction"},
                "KARURVYSYA": {"name": "Karur Vysya Bank Ltd.", "sector": "Financial Services"},
                "KAYNES": {"name": "Kaynes Technology India Ltd.", "sector": "Capital Goods"},
                "KEC": {"name": "Kec International Ltd.", "sector": "Construction"},
                "KFINTECH": {"name": "Kfin Technologies Ltd.", "sector": "Financial Services"},
                "KIRLOSENG": {"name": "Kirloskar Oil Eng Ltd.", "sector": "Capital Goods"},
                "KIMS": {"name": "Krishna Institute of Medical Sciences Ltd.", "sector": "Healthcare"},
                "LTFOODS": {"name": "LT Foods Ltd.", "sector": "Fast Moving Consumer Goods"},
                "THELEELA": {"name": "Leela Palaces Hotels & Resorts Ltd.", "sector": "Consumer Services"},
                "MMTC": {"name": "MMTC Ltd.", "sector": "Services"},
                "MRPL": {"name": "Mangalore Refinery & Petrochemicals Ltd.", "sector": "Oil Gas & Consumable Fuels"},
                "MEESHO": {"name": "Meesho Ltd.", "sector": "Consumer Services"},
                "MINDACORP": {"name": "Minda Corporation Ltd.", "sector": "Automobile and Auto Components"},
                "MSUMI": {"name": "Motherson Sumi Wiring India Ltd.", "sector": "Automobile and Auto Components"},
                "NATCOPHARM": {"name": "NATCO Pharma Ltd.", "sector": "Healthcare"},
                "NBCC": {"name": "NBCC (India) Ltd.", "sector": "Construction"},
                "NCC": {"name": "NCC Ltd.", "sector": "Construction"},
                "NSLNISP": {"name": "NMDC Steel Ltd.", "sector": "Metals & Mining"},
                "NH": {"name": "Narayana Hrudayalaya Ltd.", "sector": "Healthcare"},
                "NAVA": {"name": "Nava Ltd.", "sector": "Power"},
                "NETWEB": {"name": "Netweb Technologies India Ltd.", "sector": "Information Technology"},
                "NEULANDLAB": {"name": "Neuland Laboratories Ltd.", "sector": "Healthcare"},
                "NEWGEN": {"name": "Newgen Software Technologies Ltd.", "sector": "Information Technology"},
                "NIVABUPA": {"name": "Niva Bupa Health Insurance Company Ltd.", "sector": "Financial Services"},
                "NUVAMA": {"name": "Nuvama Wealth Management Ltd.", "sector": "Financial Services"},
                "NUVOCO": {"name": "Nuvoco Vistas Corporation Ltd.", "sector": "Construction Materials"},
                "OLAELEC": {"name": "Ola Electric Mobility Ltd.", "sector": "Automobile and Auto Components"},
                "OLECTRA": {"name": "Olectra Greentech Ltd.", "sector": "Automobile and Auto Components"},
                "ONESOURCE": {"name": "Onesource Specialty Pharma Ltd.", "sector": "Healthcare"},
                "PCBL": {"name": "PCBL Chemical Ltd.", "sector": "Chemicals"},
                "PGEL": {"name": "PG Electroplast Ltd.", "sector": "Consumer Durables"},
                "PTCIL": {"name": "PTC Industries Ltd.", "sector": "Capital Goods"},
                "PVRINOX": {"name": "PVR INOX Ltd.", "sector": "Media Entertainment & Publication"},
                "PARADEEP": {"name": "Paradeep Phosphates Ltd.", "sector": "Chemicals"},
                "PFIZER": {"name": "Pfizer Ltd.", "sector": "Healthcare"},
                "PWL": {"name": "Physicswallah Ltd.", "sector": "Consumer Services"},
                "PINELABS": {"name": "Pine Labs Ltd.", "sector": "Financial Services"},
                "PIRAMALFIN": {"name": "Piramal Finance Ltd.", "sector": "Financial Services"},
                "PPLPHARMA": {"name": "Piramal Pharma Ltd.", "sector": "Healthcare"},
                "POLYMED": {"name": "Poly Medicure Ltd.", "sector": "Healthcare"},
                "RRKABEL": {"name": "R R Kabel Ltd.", "sector": "Capital Goods"},
                "RBLBANK": {"name": "RBL Bank Ltd.", "sector": "Financial Services"},
                "RHIM": {"name": "RHI Magnesita India Ltd.", "sector": "Capital Goods"},
                "RITES": {"name": "RITES Ltd.", "sector": "Construction"},
                "RAINBOW": {"name": "Rainbow Childrens Medicare Ltd.", "sector": "Healthcare"},
                "RKFORGE": {"name": "Ramkrishna Forgings Ltd.", "sector": "Automobile and Auto Components"},
                "REDINGTON": {"name": "Redington Ltd.", "sector": "Services"},
                "RPOWER": {"name": "Reliance Power Ltd.", "sector": "Power"},
                "SBFC": {"name": "SBFC Finance Ltd.", "sector": "Financial Services"},
                "SAGILITY": {"name": "Sagility Ltd.", "sector": "Information Technology"},
                "SAILIFE": {"name": "Sai Life Sciences Ltd.", "sector": "Healthcare"},
                "SAMMAANCAP": {"name": "Sammaan Capital Ltd.", "sector": "Financial Services"},
                "SAPPHIRE": {"name": "Sapphire Foods India Ltd.", "sector": "Consumer Services"},
                "SARDAEN": {"name": "Sarda Energy and Minerals Ltd.", "sector": "Metals & Mining"},
                "SAREGAMA": {"name": "Saregama India Ltd.", "sector": "Media Entertainment & Publication"},
                "SCHNEIDER": {"name": "Schneider Electric Infrastructure Ltd.", "sector": "Capital Goods"},
                "SCI": {"name": "Shipping Corporation of India Ltd.", "sector": "Services"},
                "SOBHA": {"name": "Sobha Ltd.", "sector": "Realty"},
                "SONATSOFTW": {"name": "Sonata Software Ltd.", "sector": "Information Technology"},
                "STARHEALTH": {"name": "Star Health and Allied Insurance Ltd.", "sector": "Financial Services"},
                "SUMICHEM": {"name": "Sumitomo Chemical India Ltd.", "sector": "Chemicals"},
                "SUNTV": {"name": "Sun TV Network Ltd.", "sector": "Media Entertainment & Publication"},
                "SPLPETRO": {"name": "Supreme Petrochem Ltd.", "sector": "Chemicals"},
                "SWANCORP": {"name": "Swan Corp Ltd.", "sector": "Chemicals"},
                "SYRMA": {"name": "Syrma SGS Technology Ltd.", "sector": "Capital Goods"},
                "TBOTEK": {"name": "TBO Tek Ltd.", "sector": "Consumer Services"},
                "TATACHEM": {"name": "Tata Chemicals Ltd.", "sector": "Chemicals"},
                "TATATECH": {"name": "Tata Technologies Ltd.", "sector": "Information Technology"},
                "TTML": {"name": "Tata Teleservices (Maharashtra) Ltd.", "sector": "Telecommunication"},
                "TECHNOE": {"name": "Techno Electric & Engineering Company Ltd.", "sector": "Construction"},
                "TEGA": {"name": "Tega Industries Ltd.", "sector": "Capital Goods"},
                "TEJASNET": {"name": "Tejas Networks Ltd.", "sector": "Telecommunication"},
                "TENNIND": {"name": "Tenneco Clean Air India Ltd.", "sector": "Automobile and Auto Components"},
                "RAMCOCEM": {"name": "The Ramco Cements Ltd.", "sector": "Construction Materials"},
                "TIMKEN": {"name": "Timken India Ltd.", "sector": "Capital Goods"},
                "TITAGARH": {"name": "Titagarh Rail Systems Ltd.", "sector": "Capital Goods"},
                "TARIL": {"name": "Transformers And Rectifiers (India) Ltd.", "sector": "Capital Goods"},
                "TRAVELFOOD": {"name": "Travel Food Services Ltd.", "sector": "Consumer Services"},
                "TRIDENT": {"name": "Trident Ltd.", "sector": "Textiles"},
                "TRITURBINE": {"name": "Triveni Turbine Ltd.", "sector": "Capital Goods"},
                "URBANCO": {"name": "Urban Company Ltd.", "sector": "Consumer Services"},
                "USHAMART": {"name": "Usha Martin Ltd.", "sector": "Capital Goods"},
                "VTL": {"name": "Vardhman Textiles Ltd.", "sector": "Textiles"},
                "VIJAYA": {"name": "Vijaya Diagnostic Centre Ltd.", "sector": "Healthcare"},
                "WELCORP": {"name": "Welspun Corp Ltd.", "sector": "Capital Goods"},
                "WELSPUNLIV": {"name": "Welspun Living Ltd.", "sector": "Textiles"},
                "WOCKPHARMA": {"name": "Wockhardt Ltd.", "sector": "Healthcare"},
                "ZFCVINDIA": {"name": "ZF Commercial Vehicle Control Systems India Ltd.", "sector": "Automobile and Auto Components"},
                "ZEEL": {"name": "Zee Entertainment Enterprises Ltd.", "sector": "Media Entertainment & Publication"},
                "ZENTEC": {"name": "Zen Technologies Ltd.", "sector": "Capital Goods"},
                "ZENSARTECH": {"name": "Zensar Technologies Ltd.", "sector": "Information Technology"},
                "ZYDUSWELL": {"name": "Zydus Wellness Ltd.", "sector": "Fast Moving Consumer Goods"},
                "ECLERX": {"name": "eClerx Services Ltd.", "sector": "Services"},
}
...
class EnhancedSwingTradingSystem:
    ...
    def initialize_expanded_stock_database(self):
        try:
            ...
            # Small-caps: ALWAYS analyzable, portfolio-eligible only when flagged
            self.all_stocks_reference = dict(self.indian_stocks)
            self.all_stocks_reference.update(SMALLCAP_STOCKS)   # analysis: always

            if ENABLE_SMALLCAPS:
                self.indian_stocks.update(SMALLCAP_STOCKS)      # portfolio: gated
            ...
            logger.info(
                f"✅ Database initialized: {len(self.indian_stocks)} portfolio stocks, "
                f"{len(self.all_stocks_reference)} analyzable "
                f"[smallcaps_in_portfolio={ENABLE_SMALLCAPS}]")
