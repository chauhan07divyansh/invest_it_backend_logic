...
def verify_token():
    ...
    # --- CHANGE 2 & 3: Improved Error Handling ---
        ...
        logger.warning("JWT ERROR: Invalid token")
        return None
...
def get_disclaimer():
    """Dedicated endpoint to fetch the SEBI disclaimer — intentionally unauthenticated."""
    return jsonify({
        'success': True,
...
# --- Simple In-Memory Cache Helper Functions ---
simple_cache = {}
